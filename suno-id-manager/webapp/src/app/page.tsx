...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-slate-50 font-sans lg:flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl p-6 rounded-3xl border border-slate-700 shadow-2xl">
            ...
            <button
              ...
              className={`w-full mt-6 py-4 rounded-2xl font-black uppercase tracking-widest text-xs transition-all ${isRunning
      ...
      <main className="flex-1 overflow-y-auto p-4 pt-0 md:p-8 md:pt-0 custom-scrollbar relative h-screen overflow-auto">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex md:flex-row items-center gap-4 animate-in fade-in duration-1000 sticky top-0 bg-[#0f172a] z-100 py-6">
            ...
            {filteredResults.map((item, i) => (
              <div key={i} className="bg-slate-800/30 hover:bg-slate-800/50 transition-all p-5 rounded-[2.5rem] border border-slate-700/40 group flex flex-col h-full shadow-xl hover:shadow-2xl hover:-translate-y-1 duration-300">
                ...
                <div className="flex gap-2.5 mt-auto">
                  ...
                  <button
                    onClick={() => copyToClipboard(item.artist.replaceAll('&', ','), "Ca sĩ")}
